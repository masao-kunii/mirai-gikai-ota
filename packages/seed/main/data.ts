...
// タグデータ
// 区政テーマ（themes）と揃えたタグ。テーマの関連議案の紐付けに使う。
// featured_priority を付けたものだけトップの「タグ別議案」に出る（＝上位3つ）。
export const tags: TagInsert[] = [
  ...
  {
    label: "福祉・健康",
    description: "高齢者・障がい者福祉、健康づくり、医療に関する議案",
    featured_priority: 2,
  },
  {
    label: "まちづくり・住まい",
    description: "都市計画、住宅、道路・公園、交通に関する議案",
    featured_priority: 3,
  },
  {
    label: "環境・ごみ",
    description: "環境、ごみ・リサイクル、脱炭素に関する議案",
  },
  {
    label: "防災・安全",
    description: "防災・減災、地域の安全に関する議案",
  },
  {
    label: "産業・観光",
    description: "産業振興、中小企業、商店街、観光に関する議案",
  },
  {
    label: "地域・コミュニティ",
    description: "地域活動、多文化共生、区政運営に関する議案",
  },
];
...
export function createBillsTags(
  ...
  const billTagMap: { [billName: string]: string[] } = {
    "大田区シニア世代デジタル活用支援条例": ["福祉・健康", "地域・コミュニティ"],
    "大田区気候変動対策推進条例": ["環境・ごみ"],
    "大田区児童相談所設置条例": ["子育て・教育"],
    "令和7年度 大田区一般会計補正予算 (専決処分) の報告": ["地域・コミュニティ"],
    "区立公園の喫煙所設置に関する陳情": ["まちづくり・住まい"],
    "学校給食における国産食材使用率向上に関する請願": ["産業・観光"],
    "大田区子ども医療費助成条例の一部改正": ["子育て・教育"],
    "大田区地域包括ケアシステム推進条例": ["福祉・健康"],
    "大田区公園条例の一部改正": ["まちづくり・住まい"],
    "大田区学校給食費の無償化に関する条例": ["子育て・教育"],
    "大田区防災対策基本条例の一部改正": ["防災・安全"],
  };
