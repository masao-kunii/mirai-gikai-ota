...
export function CouncilSessionItem({ session }: CouncilSessionItemProps) {
  ...
  const handleUpdate = async () => {
    ...
    if (
      ...
      editShugiinUrl === (session.council_url ?? "") &&
    ...
    try {
      const result = await updateCouncilSession({
        ...
        name: editName,
        slug: editSlug || null,
        council_url: editShugiinUrl || null,
  ...
  const handleCancel = () => {
    ...
    setEditShugiinUrl(session.council_url ?? "");
        ...
        {isEditing ? (
          <div className="flex-1 space-y-4">
            ...
            <Input
              ...
              placeholder="議会公式URL（https://www.city.ota.tokyo.jp/gikai/...）"
              disabled={isSubmitting}
            />
          </div>
        ) : (
                        ...
                        <div className="space-y-2 text-sm text-muted-foreground">
                          ...
                          <div className="mt-4 rounded-md border border-orange-200 bg-orange-50 p-3 text-orange-800">
                            ...
                            <ul className="mt-2 list-disc list-inside text-sm">
                              <li>
                                トップページに表示される法案が、この議会会期の法案に切り替わります
                              </li>
                              <li>
